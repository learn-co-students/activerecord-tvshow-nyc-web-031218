class Show < ActiveRecord::Base
  #highest_rating: this method should return the highest value in the
  #ratings column. hint: if there is a #minimum Active Record method,
  ...
  #highest rating. hint: use the #highest_rating method as a helper method.
